...
INSERT INTO documents (id, obaa_entry,created,deleted, owner, active) VALUES (2, 'entry2', '2013-05-08',true,1, true);

INSERT INTO documents (id, obaa_entry,created, owner, active) VALUES (3, 'entry3', '2999-07-10 21:41:00',2, false);

INSERT INTO documents (id, obaa_entry,created, owner, active) VALUES (4, 'entry4', '2013-07-10 21:41:10', 5, false);

INSERT INTO documents (id, obaa_entry,created, owner, obaaxml, active) VALUES (5, 'entry5', '2013-05-08 03:10:01.015', 3, '<obaa:obaa xsi:schemaLocation="http://ltsc.ieee.org/xsd/LOM http://ltsc.ieee.org/xsd/obaav1.0/lom.xsd" xmlns:obaa="http://ltsc.ieee.org/xsd/LOM" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
   <obaa:general><obaa:title>Ataque a o TCP - Mitnick</obaa:title><obaa:keyword>TCP</obaa:keyword><obaa:structure>atomic</obaa:structure></obaa:general></obaa:obaa>',true);

INSERT INTO documents (id, obaa_entry,created, owner, obaaxml, active) VALUES (6, 'entry6', '2013-08-21 08:10:00.852', 2, '<obaa:obaa xsi:schemaLocation="http://ltsc.ieee.org/xsd/LOM http://ltsc.ieee.org/xsd/obaav1.0/lom.xsd" xmlns:obaa="http://ltsc.ieee.org/xsd/LOM" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
   <obaa:general><obaa:title>Ataque a o TCP - Mitnick</obaa:title><obaa:keyword>TCP</obaa:keyword><obaa:structure>atomic</obaa:structure></obaa:general></obaa:obaa>',true);

INSERT INTO documents (id, obaa_entry,created, owner, obaaxml, active) VALUES (7, 'entry7', '2014-02-20 13:45:55.218', 2, '<obaa:obaa xsi:schemaLocation="http://ltsc.ieee.org/xsd/LOM http://ltsc.ieee.org/xsd/obaav1.0/lom.xsd" xmlns:obaa="http://ltsc.ieee.org/xsd/LOM" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
   <obaa:general><obaa:title>Ataque a o TCP - Mitnick</obaa:title><obaa:keyword>TCP</obaa:keyword><obaa:structure>atomic</obaa:structure></obaa:general></obaa:obaa>',true);
